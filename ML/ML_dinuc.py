...
c_out = '/lhome/ext/usal053/usal0531/TFG/ML/dinuc'
...
RF.to_csv(c_out+'/dinuc_RF_results.csv')
...
for title, normalize in titles_options:
    ...
    plt.savefig(fname=c_out+"/confusionMatrix/dinuc_RF_"+title)
    print(title)
...
RG.to_csv(c_out+'/dinuc_RG_results.csv')
...
for title, normalize in titles_options:
    disp = plot_confusion_matrix(cf1, X_test, y_test,
                                 ...
                                 normalize=normalize)
    disp.ax_.set_title(title)
    plt.savefig(fname=c_out+"/confusionMatrix/dinuc_RG_"+title)
    print(title)
    print(disp.confusion_matrix)
...
NN.to_csv(c_out+'/dinuc_KNN_results.csv')
...
for title, normalize in titles_options:
    disp = plot_confusion_matrix(cf1, X_test, y_test,
                                 ...
                                 normalize=normalize)
    disp.ax_.set_title(title)
    plt.savefig(fname=c_out+"/confusionMatrix/dinuc_KNN_"+title)
    print(title)
    print(disp.confusion_matrix)
...
DT.to_csv(c_out+'/dinuc_DT_results.csv')
...
for title, normalize in titles_options:
    disp = plot_confusion_matrix(cf1, X_test, y_test,
                                 ...
                                 normalize=normalize)
    disp.ax_.set_title(title)
    plt.savefig(fname=c_out+"/confusionMatrix/dinuc_DT_"+title)
    print(title)
    print(disp.confusion_matrix)
...
NB.to_csv(c_out+'/dinuc_NB_results.csv')
...
for title, normalize in titles_options:
    disp = plot_confusion_matrix(cf1, X_test, y_test,
                                 ...
                                 normalize=normalize)
    disp.ax_.set_title(title)
    plt.savefig(fname=c_out+"/confusionMatrix/dinuc_NB_"+title)
    print(title)
    print(disp.confusion_matrix)
