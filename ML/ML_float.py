...
c_out = '/lhome/ext/usal053/usal0531/TFG/ML/float'

## Datos (solo ejecutar en caso de que no tengamos ya el archivo con todas las secuencias)
# =========================================================
dataN = pd.read_csv(c_in+'/float_Nuc_Pombe2.csv')
data = pd.read_csv(c_in+'/float_NONuc_Pombe2.csv')
...
RF.to_csv(c_out+'/float2_RF_results.csv')
...
for title, normalize in titles_options:
    ...
    plt.savefig(fname=c_out+"/confusionMatrix/float2_RF_"+title)
    print(title)
...
RG.to_csv(c_out+'/float2_RG_results.csv')
...
for title, normalize in titles_options:
    disp = plot_confusion_matrix(cf1, X_test, y_test,
                                 ...
                                 normalize=normalize)
    disp.ax_.set_title(title)
    plt.savefig(fname=c_out+"/confusionMatrix/float2_RG_"+title)
    print(title)
    print(disp.confusion_matrix)
...
NN.to_csv(c_out+'/float2_KNN_results.csv')
...
for title, normalize in titles_options:
    disp = plot_confusion_matrix(cf1, X_test, y_test,
                                 ...
                                 normalize=normalize)
    disp.ax_.set_title(title)
    plt.savefig(fname=c_out+"/confusionMatrix/float2_KNN_"+title)
    print(title)
    print(disp.confusion_matrix)
...
DT.to_csv(c_out+'/float2_DT_results.csv')
...
for title, normalize in titles_options:
    disp = plot_confusion_matrix(cf1, X_test, y_test,
                                 ...
                                 normalize=normalize)
    disp.ax_.set_title(title)
    plt.savefig(fname=c_out+"/confusionMatrix/float2_DT_"+title)
    print(title)
    print(disp.confusion_matrix)
...
NB.to_csv(c_out+'/float2_NB_results.csv')
...
for title, normalize in titles_options:
    disp = plot_confusion_matrix(cf1, X_test, y_test,
                                 ...
                                 normalize=normalize)
    disp.ax_.set_title(title)
    plt.savefig(fname=c_out+"/confusionMatrix/float2_NB_"+title)
    print(title)
    print(disp.confusion_matrix)
