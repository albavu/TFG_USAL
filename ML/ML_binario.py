...
c_out = '/lhome/ext/usal053/usal0531/TFG/ML/binario'
...
RF.to_csv(c_out+'/binario_RF_results.csv')
...
cf1 = RandomForestClassifier(criterion=rf1['criterion'], max_depth=rf1['max_depth'], max_features=rf1['max_features'], n_estimators=rf1['n_estimators'])
...
for title, normalize in titles_options:
    ...
    plt.savefig(fname=c_out+"/confusionMatrix/binario_RF_"+title)
    print(title)
...
RG.to_csv(c_out+'/binario_RG_results.csv')
...
for title, normalize in titles_options:
    disp = plot_confusion_matrix(cf1, X_test, y_test,
                                 ...
                                 normalize=normalize)
    disp.ax_.set_title(title)
    plt.savefig(fname=c_out+"/confusionMatrix/binario_RG_"+title)
    print(title)
    print(disp.confusion_matrix)
...
NN.to_csv(c_out+'/binario_KNN_results.csv')
...
for title, normalize in titles_options:
    disp = plot_confusion_matrix(cf1, X_test, y_test,
                                 ...
                                 normalize=normalize)
    disp.ax_.set_title(title)
    plt.savefig(fname=c_out+"/confusionMatrix/binario_KNN_"+title)
    print(title)
    print(disp.confusion_matrix)
...
DT.to_csv(c_out+'/binario_DT_results.csv')
...
for title, normalize in titles_options:
    disp = plot_confusion_matrix(cf1, X_test, y_test,
                                 ...
                                 normalize=normalize)
    disp.ax_.set_title(title)
    plt.savefig(fname=c_out+"/confusionMatrix/binario_DT_"+title)
    print(title)
    print(disp.confusion_matrix)
...
NB.to_csv(c_out+'/binario_NB_results.csv')
...
for title, normalize in titles_options:
    disp = plot_confusion_matrix(cf1, X_test, y_test,
                                 ...
                                 normalize=normalize)
    disp.ax_.set_title(title)
    plt.savefig(fname=c_out+"/confusionMatrix/binario_NB_"+title)
    print(title)
    print(disp.confusion_matrix)
